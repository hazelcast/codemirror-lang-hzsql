...
export type HzSQLTokenDef = {
  name: string
  version: number
}

export const HZSQL_KEYWORDS: HzSQLTokenDef[] = [
  { name: "select", version: 50 },
  { name: "distinct", version: 50 },
  { name: "as", version: 50 },
  { name: "from", version: 50 },
  { name: "inner", version: 50 },
  { name: "left", version: 50 },
  { name: "right", version: 50 },
  { name: "cross", version: 50 },
  { name: "join", version: 50 },
  { name: "on", version: 50 },
  { name: "using", version: 50 },
  { name: "where", version: 50 },
  { name: "group", version: 50 },
  { name: "by", version: 50 },
  { name: "having", version: 50 },
  { name: "order", version: 50 },
  { name: "insert", version: 50 },
  { name: "sink", version: 50 },
  { name: "into", version: 50 },
  { name: "update", version: 50 },
  { name: "set", version: 50 },
  { name: "values", version: 50 },
  { name: "delete", version: 50 },
  { name: "drop", version: 50 },
  { name: "create", version: 50 },
  { name: "or", version: 50 },
  { name: "and", version: 50 },
  ...
  { name: "external", version: 50 },
  { name: "name", version: 50 },
  { name: "type", version: 50 },
  { name: "show", version: 50 },
  { name: "view", version: 50 },
  { name: "index", version: 50 },
  { name: "job", version: 50 },
  { name: "jobs", version: 50 },
  { name: "snapshot", version: 50 },
  { name: "for", version: 50 },
  { name: "union", version: 50 },
  { name: "all", version: 50 },
...
export const HZSQL_BUILTINS: HzSQLTokenDef[] = [
  { name: "count", version: 50 },
  { name: "sum", version: 50 },
  { name: "avg", version: 50 },
  { name: "min", version: 50 },
  { name: "max", version: 50 },
  { name: "cast", version: 50 },
  { name: "extract", version: 50 },
  { name: "to_timestamp_tz", version: 50 },
  { name: "to_epoch_millis", version: 50 },
  { name: "csv_file", version: 50 },
  { name: "json_flat_file", version: 50 },
  { name: "avro_file", version: 50 },
  { name: "parquet_file", version: 50 },
  { name: "json_query", version: 50 },
  { name: "json_value", version: 50 },
  { name: "json_array", version: 50 },
  { name: "json_object", version: 50 },
  { name: "abs", version: 50 },
  { name: "cbrt", version: 50 },
  { name: "ceil", version: 50 },
  { name: "degrees", version: 50 },
  { name: "exp", version: 50 },
  { name: "floor", version: 50 },
  { name: "ln", version: 50 },
  { name: "log10", version: 50 },
  { name: "mod", version: 50 },
  { name: "power", version: 50 },
  { name: "radians", version: 50 },
  { name: "rand", version: 50 },
  { name: "round", version: 50 },
  { name: "sign", version: 50 },
  { name: "square", version: 50 },
  { name: "sqrt", version: 50 },
  { name: "truncate", version: 50 },
  { name: "ascii", version: 50 },
  { name: "btrim", version: 50 },
  { name: "concat_ws", version: 50 },
  { name: "initcap", version: 50 },
  { name: "length", version: 50 },
  { name: "lower", version: 50 },
  { name: "ltrim", version: 50 },
  { name: "position", version: 50 },
  { name: "replace", version: 50 },
  { name: "rtrim", version: 50 },
  { name: "substring", version: 50 },
  { name: "trim", version: 50 },
  { name: "upper", version: 50 },
  { name: "generate_series", version: 50 },
  { name: "generate_stream", version: 50 },
  { name: "acos", version: 50 },
  { name: "asin", version: 50 },
  { name: "atan", version: 50 },
  { name: "atan2", version: 50 },
  { name: "cos", version: 50 },
  { name: "cot", version: 50 },
  { name: "sin", version: 50 },
  { name: "tan", version: 50 },
  { name: "tumble", version: 50 },
  { name: "hop", version: 50 },
]

export const HZSQL_TYPES: HzSQLTokenDef[] = [
  { name: "boolean", version: 50 },
  { name: "varchar", version: 50 },
  { name: "tinyint", version: 50 },
  { name: "smallint", version: 50 },
  { name: "interval", version: 50 },
  { name: "json", version: 50 },
  { name: "integer", version: 50 },
  { name: "bigint", version: 50 },
  { name: "decimal", version: 50 },
  { name: "real", version: 50 },
  { name: "double", version: 50 },
  { name: "date", version: 50 },
  { name: "time", version: 50 },
  { name: "timestamp", version: 50 },
  { name: "object", version: 50 },
]

/// [HzSql](https://docs.hazelcast.com/hazelcast/5.1/sql/sql-overview) dialect.
export const HzSQL = SQLDialect.define({
  keywords: HZSQL_KEYWORDS.map(def => def.name).join(' '),
  builtin: HZSQL_BUILTINS.map(def => def.name).join(' '),
  types: HZSQL_TYPES.map(def => def.name).join(' '),
  operatorChars: "*/+-%<>!=~",
  doubleQuotedStrings: true,
  charSetCasts: true
})
